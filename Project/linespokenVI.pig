...
inputFile = LOAD 'hdfs://user/inputfiles/episodeVI_dialouges.txt' USING PigStorage('\t') AS (name:chararray, line:chararray);
...
STORE names INTO 'hdfs://user/results/episodeVI_dialouges';