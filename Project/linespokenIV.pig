...
inputFile = LOAD 'hdfs://user/inputfiles/episodeIV_dialouges.txt' USING PigStorage('\t') AS (name:chararray, line:chararray);
...
STORE names INTO 'hdfs://user/results/episodeIV_dialouges';